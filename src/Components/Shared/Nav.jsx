    ...
    <div className="navbar bg-accent px-8">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className="menu menu-compact dropdown-content mt-3 p-2 shadow  rounded-box w-52 bg-accent "
          >
            {navItems}
            <div className="">
              {user ? (
                <div className="">
                  <figure
                    className="h-10 w-10 rounded-full tooltip tooltip-bottom tooltip-info"
      ...
      <div className="navbar-end mb-2">
        ...
        {user ? (
            <div className="hidden lg:flex">
              <figure
                className="h-16 w-16 rounded-full tooltip tooltip-bottom tooltip-info -mb-[5px] mt-[2px]"
                data-tip={user.displayName ? user?.displayName : "default"}
              >
                <img
